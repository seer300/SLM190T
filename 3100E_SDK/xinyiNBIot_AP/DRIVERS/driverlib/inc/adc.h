...
/* SCAN  TIMER1 change channels */
#define SCAN_INNER_SUSPEND_EN_POS    3UL
#define SCAN_INNER_SUSPEND_EN_MSK    (1UL << SCAN_INNER_SUSPEND_EN_POS)
#define SCAN_INNER_SUSPEND_EN_EN     SCAN_INNER_SUSPEND_EN_MSK

/* SCAN  TIMER1 scan sample data */
#define SCAN_TURN_SUSPEND_EN_POS     2UL
#define SCAN_TURN_SUSPEND_EN_MSK     (1UL << SCAN_TURN_SUSPEND_EN_POS)
#define SCAN_TURN_SUSPEND_EN_EN       SCAN_TURN_SUSPEND_EN_MSK

typedef enum
{
  /* ADC通道名称       通道号    管脚                     1200   2100 */
	ADC_CMP_INP = 0,// ADC0    GPIO8                      √      √
	ADC_CMP_INN,    // ADC1    GPIO9                      √      √
	ADC_CMP_OUT,	// ADC2	   芯片内部没引出，不能使用     x      x
	ADC_OP1_INP,	// ADC3    GPIO10                     √      √
	ADC_OP1_INN,	// ADC4    GPIO11                     x      √
	ADC_OP1_OUT,	// ADC5    GPIO12                     x      √
	ADC_OP0_OUT,	// ADC6    GPIO13                     √      √
	ADC_TSENSOR,	// ADC7    TSENSOR                    √      √
	ADC_VBAT,		// ADC8    VBAT                       √      √
	ADC_OPA0_INP,	// ADC9    OPA0_INP                   √      √
	ADC_OPA0_INN,	// ADC10   OPA0_INN                   √      √
	ADC_AUX_ADC1,	// ADC11   ADC1                       x      √
	ADC_AUX_ADC2,	// ADC12   ADC2                       √      √
}ADC_CHANNEL_TypeDef;
...
void ADCCTRL_AverageModeConfig(uint8_t channelID,uint8_t ave_mode, uint8_t ave_num);
