...
#define CSP_FIFO_BYTES_RX						128
#define CSP_FIFO_BYTES_TX						128
...
#define	CSP_RX_FRAME_CTRL_I2S_ENABLE_Pos        22
#define	CSP_RX_FRAME_CTRL_I2S_ENABLE_Msk        (1UL << CSP_RX_FRAME_CTRL_I2S_ENABLE_Pos)
#define	CSP_RX_FRAME_CTRL_I2S_IDLE_LEVEL_Pos    23
#define	CSP_RX_FRAME_CTRL_I2S_IDLE_LEVEL_Msk    (1UL << CSP_RX_FRAME_CTRL_I2S_IDLE_LEVEL_Pos)
#define	CSP_RX_FRAME_CTRL_I2S_IDLE_LEVEL_HIGH   (1UL << CSP_RX_FRAME_CTRL_I2S_IDLE_LEVEL_Pos)
#define	CSP_RX_FRAME_CTRL_I2S_IDLE_LEVEL_LOW    (0UL << CSP_RX_FRAME_CTRL_I2S_IDLE_LEVEL_Pos)
#define	CSP_RX_FRAME_CTRL_I2S_LEFT_JUSTIFY_Pos  24
#define	CSP_RX_FRAME_CTRL_I2S_LEFT_JUSTIFY_Msk  (1UL << CSP_RX_FRAME_CTRL_I2S_LEFT_JUSTIFY_Pos)
...
#define	CSP_INT_RX_TIMEOUT                      (1UL << 11)
#define	CSP_INT_TX_ALLOUT                       (1UL << 12)
#define	CSP_INT_TX_RETRY_MAX                    (1UL << 13)
#define	CSP_INT_UART_PARITYCHECK_ERR            (1UL << 14)
#define	CSP_INT_RX_BREAK                        (1UL << 15)
#define	CSP_INT_ALL                             0x0000FFFF
...
//*****************************************************************************
//
// The following are defines for the bit fields in the CSP_SYNC_SLAVE_CFG register.
//
//*****************************************************************************
#define	CSP_SYNC_SLAVE_CFG_IDLE_CLK_NUM_CFG_Pos		0
#define	CSP_SYNC_SLAVE_CFG_IDLE_CLK_NUM_CFG_Msk		(3UL << CSP_SYNC_SLAVE_CFG_IDLE_CLK_NUM_CFG_Pos)
#define	CSP_SYNC_SLAVE_CFG_RFSIN2TFSIN_Pos      2
#define	CSP_SYNC_SLAVE_CFG_RFSIN2TFSIN_Msk      (1UL << CSP_SYNC_SLAVE_CFG_RFSIN2TFSIN_Pos)
#define	CSP_SYNC_SLAVE_CFG_FS_START_PLSGEN_Pos  3
#define	CSP_SYNC_SLAVE_CFG_FS_START_PLSGEN_Msk  (1UL << CSP_SYNC_SLAVE_CFG_FS_START_PLSGEN_Pos)
...
#define CSP_AYSNC_PARAM_UART_PARITYCHECK_Pos    22
#define CSP_AYSNC_PARAM_UART_PARITYCHECK_Msk    (3UL << CSP_AYSNC_PARAM_UART_PARITYCHECK_Pos)
#define CSP_UART_PARITYCHECK_None               (0UL << CSP_AYSNC_PARAM_UART_PARITYCHECK_Pos)
#define CSP_UART_PARITYCHECK_Even               (1UL << CSP_AYSNC_PARAM_UART_PARITYCHECK_Pos)
#define CSP_UART_PARITYCHECK_Odd                (2UL << CSP_AYSNC_PARAM_UART_PARITYCHECK_Pos)
#define	CSP_AYSNC_PARAM_RX_TIMEOUT_EN_Pos       24
#define	CSP_AYSNC_PARAM_RX_TIMEOUT_EN_Msk       (1UL << CSP_AYSNC_PARAM_RX_TIMEOUT_EN_Pos)
...
#define	CSP_SM_ATR_ENA_Pos						9
#define	CSP_SM_ATR_ENA_Msk						(1UL << CSP_SM_ATR_ENA_Pos)
#define	CSP_SM_RETRY_ENA_Pos					10
#define	CSP_SM_RETRY_ENA_Msk					(1UL << CSP_SM_RETRY_ENA_Pos)
#define	CSP_SM_MAX_RETRY_NUM_Pos                11
#define	CSP_SM_MAX_RETRY_NUM_Msk                (7UL << CSP_SM_MAX_RETRY_NUM_Pos)
#define	CSP_SM_TS_DETECTED_Pos                  14
#define	CSP_SM_TS_DETECTED_Msk                  (3UL << CSP_SM_TS_DETECTED_Pos)
...
#define	CSP_TX_FIFO_CTRL_WIDTH_BYTE				(0UL << CSP_TX_FIFO_CTRL_WIDTH_Pos)
#define	CSP_TX_FIFO_CTRL_WIDTH_HWORD			(1UL << CSP_TX_FIFO_CTRL_WIDTH_Pos)
#define	CSP_TX_FIFO_CTRL_WIDTH_WORD				(2UL << CSP_TX_FIFO_CTRL_WIDTH_Pos)
#define	CSP_TX_FIFO_CTRL_WIDTH_DWORD			(3UL << CSP_TX_FIFO_CTRL_WIDTH_Pos)

#define	CSP_TX_FIFO_CTRL_THD_Pos				2
#define	CSP_TX_FIFO_CTRL_THD_Msk				(0x7F << CSP_TX_FIFO_CTRL_THD_Pos)
...
#define	CSP_TX_FIFO_LEVEL_CHK_HC_Msk			(0x1F << CSP_TX_FIFO_LEVEL_CHK_HC_Pos)
...
#define	CSP_TX_FIFO_STATUS_LEVEL_Msk			(0x7F << CSP_TX_FIFO_STATUS_LEVEL_Pos)
...
#define	CSP_RX_FIFO_CTRL_WIDTH_BYTE				(0UL << CSP_RX_FIFO_CTRL_WIDTH_Pos)
#define	CSP_RX_FIFO_CTRL_WIDTH_HWORD			(1UL << CSP_RX_FIFO_CTRL_WIDTH_Pos)
#define	CSP_RX_FIFO_CTRL_WIDTH_WORD				(2UL << CSP_RX_FIFO_CTRL_WIDTH_Pos)
#define	CSP_RX_FIFO_CTRL_WIDTH_DWORD			(3UL << CSP_RX_FIFO_CTRL_WIDTH_Pos)
#define	CSP_RX_FIFO_CTRL_THD_Pos				2
#define	CSP_RX_FIFO_CTRL_THD_Msk				(0x7F << CSP_RX_FIFO_CTRL_THD_Pos)
...
#define	CSP_RX_FIFO_STATUS_LEVEL_Msk			(0x7F << CSP_RX_FIFO_STATUS_LEVEL_Pos)
