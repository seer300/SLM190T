...
//*****************************************************************************
//
// The following are defines for the bit fields in the UTC_ALARM_CLK_CNT register.
//
//*****************************************************************************
...
//230627 1200B0 watchdog_int_mask
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Pos                              (8U)
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Msk                              (0x3FUL << UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Pos )                         /*!<0x00003F00>*/
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK                                  UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Msk
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_NONE                   			(0x00000000U)
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_SECOND                        	(0x1UL << UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Pos)                           /*!<0x00000100>*/
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_MINUTE                     		(0x2UL << UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Pos)                           /*!<0x00000200>*/
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_AMPM_HOUR                    	(0x4UL << UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Pos)                           /*!<0x00000400>*/
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_MONTH                            (0x8UL << UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Pos)                           /*!<0x00000800>*/
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_DAY                              (0x10UL << UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Pos)                          /*!<0x00001000>*/
#define UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_CENTURY_YEAR                     (0x20UL << UTC_WDT_WATCHDOGCTRL_WATCHDOG_INT_MASK_Pos)                          /*!<0x00002000>*/
