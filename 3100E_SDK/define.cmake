...
list(APPEND PRJ_DEF_LIST "CP_USED_APRAM=0")  #CP向AP借用的RAM大小，KB为单位，目前未使用，严禁客户修改
...
list(APPEND PRJ_DEF_LIST "XY_WIRESHARK=1")
list(APPEND PRJ_DEF_LIST "XY_PERF=1")
list(APPEND PRJ_DEF_LIST "XY_HTTP=1")
list(APPEND PRJ_DEF_LIST "TELECOM_VER=1")
list(APPEND PRJ_DEF_LIST "MOBILE_VER=1")
list(APPEND PRJ_DEF_LIST "CTWING_VER=1")
list(APPEND PRJ_DEF_LIST "LIBCOAP=1")
list(APPEND PRJ_DEF_LIST "MQTT=1")
list(APPEND PRJ_DEF_LIST "WAKAAMA=1")
# list(APPEND PRJ_DEF_LIST "WEBLOG=0")
list(APPEND PRJ_DEF_LIST "XY_DM=1")
list(APPEND PRJ_DEF_LIST "WITH_MBEDTLS_SUPPORT=1")
