...
#define TIMRE_CNT_OFFSET        0x00000010  // Timer count mode and the offset of count
//*****************************************************************************
//
...
#define TIMER_CNT_COUNT_Msk     0xFFFFFFFF
...
#define TIMER_RLD_RELOAD_Msk    0xFFFFFFFF
...
#define TIMER_PWM_PWM_Msk       0xFFFFFFFF
...
#define TIMER_CTL_TICONFIG_ALL_EVENT    (0UL << TIMER_CTL_TICONFIG_Pos) // Reload/Compare/Capture/Deassertion
#define TIMER_CTL_TICONFIG_OUTER_EVENT  (2UL << TIMER_CTL_TICONFIG_Pos) // Capture/Deassertion
#define TIMER_CTL_TICONFIG_INNER_EVENT  (3UL << TIMER_CTL_TICONFIG_Pos) // Reload/Compare
...
//*****************************************************************************
//
// The following are defines for the bit fields in the TIMER_CNT_OFFSET register.
//
//*****************************************************************************  
#define TIMER_CNT_DIR_Pos               31
#define TIMER_CNT_DIR_UP                (0 << TIMER_CNT_DIR_Pos) 
#define TIMER_CNT_DIR_DOWN              (1 << TIMER_CNT_DIR_Pos)
