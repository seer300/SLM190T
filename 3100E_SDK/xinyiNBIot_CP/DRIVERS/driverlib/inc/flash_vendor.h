...
extern void FLASH_GetRDID(unsigned char *pucRdid);
...
extern uint8_t FLASH_GetStatusReg1(void);
extern uint8_t FLASH_GetStatusReg2(void);
extern uint8_t FLASH_need_Resume(QSPI_FLASH_Def* flash_vendor);
extern void FLASH_PE_Suspend(void);
extern void FLASH_PE_Resume(void);
