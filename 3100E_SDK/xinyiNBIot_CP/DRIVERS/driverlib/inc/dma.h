...
extern void DMAChannelNextPointerSet(unsigned long ulChannelNum, unsigned long pvNextPointer);
...
extern unsigned long DMAChannelRmapAddr(void *pvSrcAddr, unsigned char ucMemType);
