...
//
//*****************************************************************************
#define TRNG_SW_RESET    			(TRNG_BASE + HW_RNG_SW_RESET_REG_ADDR)
#define TRNG_CLK_ENABLE				(TRNG_BASE + HW_RNG_CLK_ENABLE_REG_ADDR)
#define TRNG_SAMPLE_CNT1			(TRNG_BASE + HW_SAMPLE_CNT1_REG_ADDR)
#define TRNG_CONFIG_REG				(TRNG_BASE + HW_TRNG_CONFIG_REG_ADDR)
#define TRNG_DEBUG_CONTROL			(TRNG_BASE + HW_TRNG_DEBUG_CONTROL_REG_ADDR)
#define TRNG_RND_SOURCEE			(TRNG_BASE + HW_RND_SOURCE_ENABLE_REG_ADDR)
#define TRNG_VALID_REG				(TRNG_BASE + HW_TRNG_VALID_REG_ADDR)
#define TRNG_IMR_REG				(TRNG_BASE + HW_RNG_IMR_REG_ADDR)
#define TRNG_ISR_REG				(TRNG_BASE + HW_RNG_ISR_REG_ADDR)
#define TRNG_ICR_REG				(TRNG_BASE + HW_RNG_ICR_REG_ADDR)
#define TRNG_EHR_DATA_ADDR_0		(TRNG_BASE + HW_EHR_DATA_ADDR_0_REG_ADDR)

//*****************************************************************************
//
// RNG module registers and offset defination.
//
//*****************************************************************************
...
//*****************************************************************************
//
// RNG module set value defination.
//
//*****************************************************************************
...
//*****************************************************************************
//
// RNG module INT MASK value Set.
//
//*****************************************************************************
#define TRNG_IMR_ALL_MASK                   0xF
#define TRNG_IMR_EHR_INT_MASK               0x1
