#ifndef DIAG_MSG_TYPE_H
#define DIAG_MSG_TYPE_H
...
typedef enum
{   
    ENUM_SHOW_NAME(L2_THREAD_ID, L2)         = LAYER2,
    ENUM_SHOW_NAME(NAS_THREAD_ID, NAS)       = NAS,
    ENUM_SHOW_NAME(BIP_THREAD_ID, BIP)       = BIP,
    ENUM_SHOW_NAME(LNBPS_MAX_THREAD, LNBPS)  = LNBPS,

    ENUM_SHOW_NAME(ADMIN_THREAD_ID, ADMIN)   = ADMIN,
    ENUM_SHOW_NAME(LPHY_THREAD_ID, LPHY)     = LPHY,
    ENUM_SHOW_NAME(LRRC_THREAD_ID, LRRC)     = LRRC,
    ENUM_SHOW_NAME(UART_THREAD_ID, AT_UART)  = AT_UART,

    ENUM_SHOW_NAME(OM_THREAD_ID, OM)         = NAS_THREAD_ID,
    ENUM_SHOW_NAME(ATC_AP_THREAD_ID, ATC_AP) = ATC_AP,
...
typedef enum
{
    ...
    MSG_SHOW_NAME(LNB_PHY_SR_REQ,                    LNB_PhySR_Req_STRU)                     = 0x0012,
    MSG_SHOW_NAME(LNB_PHY_ACCESS_CNF,               LNB_PhyAccessCnf_STRU)                  = 0x0013,
...
typedef enum
{
    ...
    MSG_SHOW_NAME(LNB_CPHY_COMMON_CH_CONFIG_REQ,            LNB_PHY_COMMON_CH_CONFIG_STRU)         = 0x000e,
    ...
    MSG_SHOW_NAME(LNB_CPHY_MEAS_ACC_ENHANCE_CFG_REQ,        LNB_PHY_MEAS_ACC_ENHANCE_CONFIG_STRU)     = 0x001F,
    MSG_SHOW_NAME(LNB_CPHY_RRC_RLS_ACK_REQ,                 LNB_PHY_RRC_RLS_ACK_REQ_STRU)           = 0x0020,
    MSG_SHOW_NAME(LNB_CPHY_RRC_RLS_ACK_SND_IND,             LNB_PHY_RRC_RLS_ACK_SND_IND_STRU)       = 0x0021,
...
typedef enum
{
	...
	MSG_SHOW_NAME(LNB_MAC_RAI_REQ,							LNB_MAC_RAI_REQ_STRU) = 0x000A,	
    MSG_SHOW_NAME(LNB_MAC_RSRP_IND,                            LNB_MAC_RSRP_IND_STRU) = 0x000D,
    MSG_SHOW_NAME(LNB_MAC_SR_REL_IND,                        LNB_MAC_SR_REL_IND_STRU) = 0x000E,
    MSG_SHOW_NAME(LNB_MAC_LARGE_TX_SCHEDULING_IND,           LNB_MAC_LARGE_TX_SCHEDULING_IND_STRU) = 0x000F,
...
{    
    ...
    MSG_SHOW_NAME(MSG_LNB_PDCP_SUSPEND_REQ,                    LNB_PDCP_SUSPEND_REQ_STRU) = 4,
    MSG_SHOW_NAME(MSG_LNB_PDCP_RESUME_REQ,                    LNB_PDCP_RESUME_REQ_STRU) = 5,
    MSG_SHOW_NAME(MSG_LNB_PDCP_PSM_RESP,                    LNB_PDCP_PSM_RESP_Payload_STRU) = 6,
    MSG_SHOW_NAME(MSG_LNB_PDCP_EDT_ULDATA_IND,                LNB_PDCP_EDT_ULDATA_IND_STRU) = 7,
...
typedef enum
{
    ...
    MSG_SHOW_NAME(LNB_RRC_PLMN_SEARCH_STOP_REQ,               LNB_RRC_PLMN_SEARCH_STOP_REQ_STRU) = 0x00000014,
    ...
    MSG_SHOW_NAME(LNB_RRC_CELLLIST_SEARCH_REQ,                LNB_RRC_CELLLIST_REQ_STRU) = 0x00000021,
    MSG_SHOW_NAME(LNB_RRC_CELLLIST_SEARCH_CNF,                LNB_RRC_CELLLIST_CNF_STRU) = 0x00000022,
}LRRC_NAS_AP_CLASS_E;
...
typedef enum
{
    ...
    MSG_SHOW_NAME(UICC_ESIM_EID_READ_REQ,	                MSG_HEADER_STRU),
    MSG_SHOW_NAME(UICC_ESIM_EID_READ_CNF,	                UICC_ESIM_EID_READ_CNF_MSG_STRU),
    MSG_SHOW_NAME(UICC_POWEROFF_IND,                        MSG_HEADER_STRU),
#ifdef BIP_FEATURE
    MSG_SHOW_NAME(UICC_BIP_MSG_RECV_DATA_REQ,               BIP_RECV_DATA_REQ), //0x49
    MSG_SHOW_NAME(UICC_BIP_MSG_RECV_DATA_CNF,               BIP_RECV_DATA_CNF), //0x4A
    MSG_SHOW_NAME(UICC_EVENT_LOCATION_STATUS,               UICC_LOCATION_STATUS_EVENT_IND), //0x4B
    MSG_SHOW_NAME(UICC_LOCATION_INFO_REQ,                   BIP_LOCATION_INFO_REQ),
    MSG_SHOW_NAME(UICC_LOCATION_INFO_CNF,                   BIP_LOCATION_INFO_CNF),
    MSG_SHOW_NAME(UICC_BIP_MSG_TIMERMNAGE_EXPIRE_IND,       UICC_TIMER_MANAGEMENT_EXPIRE_IND), //0x4E
#endif
...
typedef enum
{
	...
	MSG_SHOW_NAME(D_EPS_ENTER_PSM_IND,                        MSG_HEADER_STRU)                        = 0x34,
}ATC_NAS_AP_CLASS_E;
...
typedef enum
{
    ...
    MSG_SHOW_NAME( MESSAGE_TYPE_DETACH_ACCEPT ,               ST_LTE_DETACH_ACCEPT   ) = 0x46,
    ...
    MSG_SHOW_NAME( MESSAGE_TYPE_OPEN_UE_TEST_LOOP,             ST_LTC_OPEN_UE_TEST_LOOP) =  0x82,
...
typedef enum
{
    ...
    MSG_SHOW_NAME(XY_SUBSYS_PHY_RAW_DATA_CNF, LCPHY_RAW_DATA_t),
