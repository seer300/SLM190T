...
#define coap_malloc_type(type, size) xy_malloc(size)
#define coap_free_type(type, pPool) xy_free(pPool)
...
#define coap_malloc(size) xy_malloc(size)
#define coap_free(pointer) xy_free(pointer)
/*COAP_STATIC_INLINE void *coap_malloc(size_t size) {
