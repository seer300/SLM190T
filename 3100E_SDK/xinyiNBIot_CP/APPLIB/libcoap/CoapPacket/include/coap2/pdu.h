...
#define LIBCOAP_COAP_OPTION_IF_MATCH        1 /* C, opaque, 0-8 B, (none) */
#define LIBCOAP_COAP_OPTION_URI_HOST        3 /* C, String, 1-255 B, destination address */
#define LIBCOAP_COAP_OPTION_ETAG            4 /* E, opaque, 1-8 B, (none) */
#define LIBCOAP_COAP_OPTION_IF_NONE_MATCH   5 /* empty, 0 B, (none) */
#define LIBCOAP_COAP_OPTION_URI_PORT        7 /* C, uint, 0-2 B, destination port */
#define LIBCOAP_COAP_OPTION_LOCATION_PATH   8 /* E, String, 0-255 B, - */
#define LIBCOAP_COAP_OPTION_URI_PATH       11 /* C, String, 0-255 B, (none) */
#define LIBCOAP_COAP_OPTION_CONTENT_FORMAT 12 /* E, uint, 0-2 B, (none) */
#define LIBCOAP_COAP_OPTION_CONTENT_TYPE LIBCOAP_COAP_OPTION_CONTENT_FORMAT
#define LIBCOAP_COAP_OPTION_MAXAGE         14 /* E, uint, 0--4 B, 60 Seconds */
#define LIBCOAP_COAP_OPTION_URI_QUERY      15 /* C, String, 1-255 B, (none) */
#define LIBCOAP_COAP_OPTION_ACCEPT         17 /* C, uint,   0-2 B, (none) */
#define LIBCOAP_COAP_OPTION_LOCATION_QUERY 20 /* E, String,   0-255 B, (none) */
#define LIBCOAP_COAP_OPTION_SIZE2          28 /* E, uint, 0-4 B, (none) */
#define LIBCOAP_COAP_OPTION_PROXY_URI      35 /* C, String, 1-1034 B, (none) */
#define LIBCOAP_COAP_OPTION_PROXY_SCHEME   39 /* C, String, 1-255 B, (none) */
#define LIBCOAP_COAP_OPTION_SIZE1          60 /* E, uint, 0-4 B, (none) */

/* option types from RFC 7641 */

#define LIBCOAP_COAP_OPTION_OBSERVE         6 /* E, empty/uint, 0 B/0-3 B, (none) */
#define LIBCOAP_COAP_OPTION_SUBSCRIPTION  LIBCOAP_COAP_OPTION_OBSERVE

/* selected option types from RFC 7959 */

#define LIBCOAP_COAP_OPTION_BLOCK2         23 /* C, uint, 0--3 B, (none) */
#define LIBCOAP_COAP_OPTION_BLOCK1         27 /* C, uint, 0--3 B, (none) */

/* selected option types from RFC 7967 */

#define LIBCOAP_COAP_OPTION_NORESPONSE    258 /* N, uint, 0--1 B, 0 */

#define LIBCOAP_COAP_MAX_OPT            65535 /**< the highest option number we know */
