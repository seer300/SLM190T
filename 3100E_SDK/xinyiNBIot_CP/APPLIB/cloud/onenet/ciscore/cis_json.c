    ...
    do
    {
        ...
        case 1:
        {
            ...
            case 'n':
            {
                ...
                if (recordP->ids[0] != URI_INVALID) return -1;
                             ...
                             st_data_t ** dataP)
{
    ...
    for (index = 0 ; index < count ; index++)
    {
        ...
        {
            if (recordArray[index].ids[i] == URI_INVALID) goto error;
        }
        if (resSegmentIndex < 2)
        {
            if (recordArray[index].ids[resSegmentIndex + 2] != URI_INVALID) goto error;
        }
               ...
               st_data_t ** dataP)
{
    ...
    *dataP = NULL;
    ...
    if (eFound == true)
    {
        ...
        {
            if (parsedP->type != DATA_TYPE_OBJECT || parsedP->id != uriP->objectId) goto error;
            if (!URI_IS_SET_INSTANCE(uriP))
            {
                              ...
                              size_t bufferLen)
{
    ...
    case DATA_TYPE_STRING:
        ...
        if (bufferLen - head < tlvP->asBuffer.length) return -1;
    ...
    case DATA_TYPE_INTEGER:
    {
        ...
        if (0 == data_decode_int(tlvP, &value)) return -1;
    ...
    case DATA_TYPE_FLOAT:
    {
        ...
        if (0 == data_decode_float(tlvP, &value)) return -1;
    ...
    case DATA_TYPE_BOOL:
    {
        ...
        if (0 == data_decode_bool(tlvP, &value)) return -1;
