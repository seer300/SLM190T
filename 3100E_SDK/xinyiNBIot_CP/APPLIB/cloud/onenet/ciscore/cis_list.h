...
CIS_API cis_list_t *  cis_packet_add(cis_list_t * head, cis_list_t * node);
...
CIS_API cis_list_t *  cis_list_find_u16_ext(cis_list_t * head,uint16_t id);
...
#define CIS_LIST_FIND_U16_EXT(H,I)  cis_list_find_u16_ext((cis_list_t *)H, I)
