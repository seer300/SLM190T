...
lwm2m_list_t * ctlw_lwm2m_list_add(lwm2m_list_t * head,
                              lwm2m_list_t * node)
{
    lwm2m_list_t * target;
...
lwm2m_list_t * ctlw_lwm2m_list_find(lwm2m_list_t * head,
                               uint16_t id)
{
...
lwm2m_list_t * ctlw_lwm2m_list_remove(lwm2m_list_t * head,
                                 uint16_t id,
                                 lwm2m_list_t ** nodeP)
{
    lwm2m_list_t * target;
...
void ctlw_lwm2m_list_free(lwm2m_list_t * head)
{
    if (head != NULL)
    {
        ...
        nextP = head->next;
        ctlw_lwm2m_free(head);
        ctlw_lwm2m_list_free(nextP);
    }
}
